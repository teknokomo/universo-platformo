...
**This repository is working on implementing Universo Platformo / Universo MMOOMM using Godot 4 and Strapi CMS.** We assume that Universo MMOOMM will become the largest project implemented on Godot and will help popularize this wonderful engine. The tech stack will be described in more detail in the near future. This implementation on this tech stack is currently a priority, as it combines ease of implementation and great capabilities.

Also, since 2018, experiments have been underway to implement Universo Platformo / Universo MMOOMM on various other tech stacks, in particular, we have developments on [PlayCanvas](https://github.com/teknokomo/universo-platformo-nebulo) and Godot 3 [here is a video](https://youtu.be/BbAEiScmxQo) of what it looked like (in Russian).
...
This GitHub repository is where we work with code, collect our Issues, discussions and documentation. This repository will also have clones on other services, such as GitVerse.ru.
